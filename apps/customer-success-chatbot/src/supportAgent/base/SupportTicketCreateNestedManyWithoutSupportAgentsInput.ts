...
@InputType()
class SupportTicketCreateNestedManyWithoutSupportAgentsInput {
...
export { SupportTicketCreateNestedManyWithoutSupportAgentsInput as SupportTicketCreateNestedManyWithoutSupportAgentsInput };
