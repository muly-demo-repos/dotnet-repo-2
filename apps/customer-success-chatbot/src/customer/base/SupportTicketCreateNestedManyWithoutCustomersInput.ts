...
@InputType()
class SupportTicketCreateNestedManyWithoutCustomersInput {
...
export { SupportTicketCreateNestedManyWithoutCustomersInput as SupportTicketCreateNestedManyWithoutCustomersInput };
